...
const ModalProducto = () => {
    ...
    //para que cuando cambie de estado el pedido verifique si ya existe ese producto en el pedido, en dado caso
    //va a actualizar el pedido (solo la pura cantidad)
    useEffect(() => {
